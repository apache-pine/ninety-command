...
import { addTeamDropdown, addUserDropdown, runSubmit, widenField } from "./formHelpers";
...
/**
 * Holds the Create/Edit Issue form's state and rendering logic, independent
...
export class IssueFormController {
	...
	async mount(contentEl: HTMLElement): Promise<void> {
		contentEl.createEl("h2", { text: this.isEdit ? "Edit Issue" : "Create Issue" });
